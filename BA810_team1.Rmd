...
predicted.CHD <- ifelse(test.predictions > 0.10, 1, 0)
...
### 3. Split dataset again based on the result of Lasso.
```{r}
train2<-train
test2<-test
train2$education=NULL
train2$currentSmoker=NULL
train2$diaBP=NULL
train2$BMI=NULL
train2$heartRate=NULL
test2$education=NULL
test2$currentSmoker=NULL
test2$diaBP=NULL
test2$BMI=NULL
test2$heartRate=NULL
```
